...
public class MoneyTransferWorker {
    ...
    public static void main(String[] args) {
        ...
        WorkflowClientOptions workflowClientOptions = WorkflowClientOptions.newBuilder().setNamespace("dev").build();
        WorkflowClient client = WorkflowClient.newInstance(serviceStub, workflowClientOptions);
        ...
        worker.registerWorkflowImplementationTypes(MoneyTransferWorkflowImpl.class, BalanceWorkflowImpl.class);
